            ...
            <div className="mx-auto w-full max-w-[550px] bg-white bg-opacity-100 rounded-md shadow-md">
                ...
                >
                    ...
                    <div className="mb-5">
                        ...
                        <select className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" onChange={(e) => setExperience(e.target.value)}>
                            <option defaultValue value="Seleccionar">Seleccionar</option>
